...
Check [example_command.py](https://github.com/CryptoLover705/discord-bot-template/blob/master/commands/example_command.py) and [example_event.py](https://github.com/CryptoLover705/discord-bot-template/blob/master/events/example_event.py) for an example on how to implement commands and events, or keep reading for more detailed info.
...
Have a look at [commands/example_command.py](https://github.com/CryptoLover705/discord-bot-template/blob/master/commands/example_command.py) for a more fool-proof implementation for `!random`.
